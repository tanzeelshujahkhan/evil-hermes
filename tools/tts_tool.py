...
# custom voice-cloning scripts, etc.) into Evil Hermes without any Python code
...
#           output_format: wav
#
# Evil Hermes writes the input text to a temp UTF-8 file, runs the command with
...
def _generate_xai_tts(text: str, output_path: str, tts_config: Dict[str, Any]) -> str:
    ...
    # output_format when Evil Hermes actually needs a non-default format/override.
