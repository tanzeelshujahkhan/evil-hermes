...
# which is shown to the user on install, but no verdict blocks.
#
# The skill scanner itself is preserved — it still runs, still emits
# findings, and the install flow still shows the report. The verdict just
# no longer gates the install.
INSTALL_POLICY = {
