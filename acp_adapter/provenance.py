...
This is an additive Evil Hermes extension surfaced under ACP ``_meta.hermes`` so
...
compression rotates the internal Evil Hermes head, ``build_session_provenance`` lets
...
def build_session_provenance(
    ...
    *,
    ...
    Args:
        ...
        current_hermes_session_id: The live internal Evil Hermes DB session id
