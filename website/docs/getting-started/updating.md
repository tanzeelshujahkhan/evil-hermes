...
description: "How to update Evil Hermes to the latest version or uninstall it"
---
...
🔄 Restarting gateways...
✅ Gateway restarted
✅ Evil Hermes updated successfully!
```
...
Compare against the latest release at the [GitHub releases page](https://github.com/tanzeelshujahkhan/evil-hermes/releases).
