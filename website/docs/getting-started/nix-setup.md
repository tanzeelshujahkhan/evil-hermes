...
description: "Install and deploy Evil Hermes with Nix — from quick `nix run` to fully declarative NixOS module with container mode"
---
...
Evil Hermes ships a Nix flake & a NixOS module.
...
| Check | What it tests |
|---|---|
| `package-contents` | `hermes` and `evil-hermes` binaries exist and `hermes version` runs |
