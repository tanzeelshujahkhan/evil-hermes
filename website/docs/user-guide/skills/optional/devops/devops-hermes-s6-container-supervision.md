...
description: "Modify, debug, or extend the s6-overlay supervision tree inside the Evil Hermes Docker image — adding new services, debugging profile gateways, understandin..."
---
...
Modify, debug, or extend the s6-overlay supervision tree inside the Evil Hermes Docker image — adding new services, debugging profile gateways, understanding the Architecture B main-program pattern.
...
| Related skills | [`evil-hermes`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-hermes-agent), `evil-hermes-dev` |
...
If you're just running the Evil Hermes and want to use Docker, see `website/docs/user-guide/docker.md` instead.
...
- `evil-hermes-dev`: General Evil Hermes codebase navigation
