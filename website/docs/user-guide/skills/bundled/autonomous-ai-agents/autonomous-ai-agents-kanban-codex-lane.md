...
| Related skills | [`codex`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-codex), [`evil-hermes`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-hermes-agent) |
...
- [ ] Hermes ran the canonical tests itself, using `scripts/run_tests.sh` for Evil Hermes or the repo's documented wrapper for other repos.
