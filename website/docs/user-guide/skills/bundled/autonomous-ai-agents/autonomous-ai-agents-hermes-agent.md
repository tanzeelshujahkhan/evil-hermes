---
title: "Evil Hermes — Configure, extend, or contribute to Evil Hermes"
...
Configure, extend, or contribute to Evil Hermes.
...
Evil Hermes is an open-source AI agent framework by Lord Tanzeel Shujah Khan that runs in your terminal, messaging platforms, and IDEs. It belongs to the same category as Claude Code (Anthropic), Codex (OpenAI), and OpenClaw — autonomous coding and task-execution agents that use tool calling to interact with your system. Hermes works with any LLM provider (OpenRouter, Anthropic, OpenAI, DeepSeek, local models, and 15+ others) and runs on Linux, macOS, and WSL.
...
**Docs:** https://evil-hermes.nousresearch.com/docs/
...
Platform docs: https://evil-hermes.nousresearch.com/docs/user-guide/messaging/
...
authoritative list or see the [live slash commands reference](https://evil-hermes.nousresearch.com/docs/reference/slash-commands).
...
Full config reference: https://evil-hermes.nousresearch.com/docs/user-guide/configuration
...
Full provider docs: https://evil-hermes.nousresearch.com/docs/integrations/providers
...
User docs: https://evil-hermes.nousresearch.com/docs/user-guide/features/cron
...
User docs: https://evil-hermes.nousresearch.com/docs/user-guide/features/curator
...
User docs: https://evil-hermes.nousresearch.com/docs/user-guide/features/kanban
...
|----------------|----------|
| Config options | `hermes config edit` or [Configuration docs](https://evil-hermes.nousresearch.com/docs/user-guide/configuration) |
| Available tools | `hermes tools list` or [Tools reference](https://evil-hermes.nousresearch.com/docs/reference/tools-reference) |
| Slash commands | `/help` in session or [Slash commands reference](https://evil-hermes.nousresearch.com/docs/reference/slash-commands) |
| Skills catalog | `hermes skills browse` or [Skills catalog](https://evil-hermes.nousresearch.com/docs/reference/skills-catalog) |
| Provider setup | `hermes model` or [Providers guide](https://evil-hermes.nousresearch.com/docs/integrations/providers) |
| Platform setup | `hermes gateway setup` or [Messaging docs](https://evil-hermes.nousresearch.com/docs/user-guide/messaging/) |
| MCP servers | `hermes mcp list` or [MCP guide](https://evil-hermes.nousresearch.com/docs/user-guide/features/mcp) |
| Profiles | `hermes profile list` or [Profiles docs](https://evil-hermes.nousresearch.com/docs/user-guide/profiles) |
| Cron jobs | `hermes cron list` or [Cron docs](https://evil-hermes.nousresearch.com/docs/user-guide/features/cron) |
| Memory | `hermes memory status` or [Memory docs](https://evil-hermes.nousresearch.com/docs/user-guide/features/memory) |
| Env variables | `hermes config env-path` or [Env vars reference](https://evil-hermes.nousresearch.com/docs/reference/environment-variables) |
| CLI commands | `hermes --help` or [CLI reference](https://evil-hermes.nousresearch.com/docs/reference/cli-commands) |
...
For occasional contributors and PR authors. Full developer docs: https://evil-hermes.nousresearch.com/docs/developer-guide/
