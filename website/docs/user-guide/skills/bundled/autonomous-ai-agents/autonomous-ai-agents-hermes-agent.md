...
Platform docs: https://evil-hermes.local/docs/user-guide/messaging/
...
authoritative list or see the [live slash commands reference](https://evil-hermes.local/docs/reference/slash-commands).
...
Full config reference: https://evil-hermes.local/docs/user-guide/configuration
...
Full provider docs: https://evil-hermes.local/docs/integrations/providers
...
User docs: https://evil-hermes.local/docs/user-guide/features/cron
...
User docs: https://evil-hermes.local/docs/user-guide/features/curator
...
User docs: https://evil-hermes.local/docs/user-guide/features/kanban
...
|----------------|----------|
| Config options | `hermes config edit` or [Configuration docs](https://evil-hermes.local/docs/user-guide/configuration) |
| Available tools | `hermes tools list` or [Tools reference](https://evil-hermes.local/docs/reference/tools-reference) |
| Slash commands | `/help` in session or [Slash commands reference](https://evil-hermes.local/docs/reference/slash-commands) |
| Skills catalog | `hermes skills browse` or [Skills catalog](https://evil-hermes.local/docs/reference/skills-catalog) |
| Provider setup | `hermes model` or [Providers guide](https://evil-hermes.local/docs/integrations/providers) |
| Platform setup | `hermes gateway setup` or [Messaging docs](https://evil-hermes.local/docs/user-guide/messaging/) |
| MCP servers | `hermes mcp list` or [MCP guide](https://evil-hermes.local/docs/user-guide/features/mcp) |
| Profiles | `hermes profile list` or [Profiles docs](https://evil-hermes.local/docs/user-guide/profiles) |
| Cron jobs | `hermes cron list` or [Cron docs](https://evil-hermes.local/docs/user-guide/features/cron) |
| Memory | `hermes memory status` or [Memory docs](https://evil-hermes.local/docs/user-guide/features/memory) |
| Env variables | `hermes config env-path` or [Env vars reference](https://evil-hermes.local/docs/reference/environment-variables) |
...
For occasional contributors and PR authors. Full developer docs: https://evil-hermes.local/docs/developer-guide/
