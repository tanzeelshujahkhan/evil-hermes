...
sidebar_position: 1
title: "Telegram"
description: "Set up Evil Hermes as a Telegram bot"
---

# Telegram Setup

Evil Hermes integrates with Telegram as a full-featured conversational bot. Once connected, you can chat with your agent from any device, send voice memos that get auto-transcribed, receive scheduled task results, and use the agent in group chats. The integration is built on [python-telegram-bot](https://python-telegram-bot.org/) and supports text, voice, images, and file attachments.
...
2. Send `/newbot`
3. Choose a **display name** (e.g., "Evil Hermes") — this can be anything
...
Evil Hermes uses numeric Telegram user IDs to control access. Your user ID is **not** your username — it's a number like `123456789`.
...
Evil Hermes works in Telegram group chats with a few considerations:
