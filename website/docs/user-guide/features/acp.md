...
description: "Use Evil Hermes inside ACP-compatible editors such as VS Code, Zed, and JetBrains"
---

# ACP Editor Integration

Evil Hermes can run as an ACP server, letting ACP-compatible editors talk to Hermes over stdio and render:
...
2. Select **Evil Hermes** from the built-in agent list.
...
- In Zed, open the ACP Registry with `zed: acp registry` and search for **Evil Hermes**.
...
Install `uv` from the official uv installation docs, then retry the Evil Hermes thread from Zed.
