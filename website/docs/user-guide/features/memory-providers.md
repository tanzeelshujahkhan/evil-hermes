...
**Config:** `$HERMES_HOME/honcho.json` (profile-local) or `~/.honcho/config.json` (global). Resolution order: `$HERMES_HOME/honcho.json` > `~/.hermes/honcho.json` > `~/.honcho/config.json`. See the [config reference](https://github.com/TanzeelShujahKhan/evil-hermes/blob/main/plugins/memory/honcho/README.md) and the [Honcho integration guide](https://docs.honcho.dev/v3/guides/integrations/hermes).
...
See the [config reference](https://github.com/TanzeelShujahKhan/evil-hermes/blob/main/plugins/memory/honcho/README.md) and [Honcho integration guide](https://docs.honcho.dev/v3/guides/integrations/hermes).
...
See [plugin README](https://github.com/TanzeelShujahKhan/evil-hermes/blob/main/plugins/memory/hindsight/README.md) for the full configuration reference.
