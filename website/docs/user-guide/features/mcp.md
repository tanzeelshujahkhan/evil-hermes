...
`optional-mcps/` in the evil-hermes repo — presence in that directory means
...
the evil-hermes repo, so Nous has reviewed each entry before it shipped —
...
Manifests live at
[`optional-mcps/<name>/manifest.yaml`](https://github.com/TanzeelShujahKhan/evil-hermes/tree/main/optional-mcps)
...
[`optional-mcps/`](https://github.com/TanzeelShujahKhan/evil-hermes/tree/main/optional-mcps).
