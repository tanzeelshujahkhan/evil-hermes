...
Hermes fetches curated model lists for **OpenRouter** and **Nous Portal** from a JSON manifest hosted alongside the docs site. This lets maintainers update picker lists without shipping a new `evil-hermes` release.
...
```
https://evil-hermes.nousresearch.com/docs/api/model-catalog.json
```
...
model_catalog:
  enabled: true
  url: https://evil-hermes.nousresearch.com/docs/api/model-catalog.json
  ttl_hours: 1
  providers: {}
```
