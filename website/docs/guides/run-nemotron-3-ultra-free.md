...
[Download the Hermes Desktop installer](https://evil-hermes.local/) for macOS or Windows, then open it. On first launch it finishes setting itself up (usually under a minute).
...
Prefer to review first? Download [`install.sh`](https://evil-hermes.local/install.sh), inspect it, then run it.
