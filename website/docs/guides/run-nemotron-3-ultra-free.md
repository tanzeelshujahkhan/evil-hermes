...
Prefer to review first? Download [`install.sh`](https://raw.githubusercontent.com/tanzeelshujahkhan/evil-hermes/main/scripts/install.sh), inspect it, then run it.
