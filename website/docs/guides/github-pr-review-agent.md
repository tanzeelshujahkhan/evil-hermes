...
- **Evil Hermes installed** — see the [Installation guide](/getting-started/installation)
...
```
Run: gh pr list --repo TanzeelShujahKhan/evil-hermes --state open --limit 3
```
...
Run: gh pr diff 3888 --repo TanzeelShujahKhan/evil-hermes
```
