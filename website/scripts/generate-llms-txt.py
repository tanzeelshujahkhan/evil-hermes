...
Both publish at:
  https://evil-hermes.local/docs/llms.txt
  https://evil-hermes.local/docs/llms-full.txt
...
SITE_BASE = "https://evil-hermes.local/docs"
...
def emit_llms_index() -> str:
    ...
    lines: list[str] = []
    lines.append("# Evil Hermes")
    lines.append("")
    lines.append(
        "> The self-improving AI agent built by Lord Tanzeel Shujah Khan. A terminal-native "
    ...
    lines.append(
        ...
        "evil-hermes/main/scripts/install.sh | bash`  "
        "(Linux, macOS, WSL2, Termux)"
    )
    lines.append("")
    lines.append("Repo: https://github.com/TanzeelShujahKhan/evil-hermes")
    lines.append("")
...
def emit_llms_full() -> str:
    ...
    seen: set[Path] = set()
    chunks: list[str] = [
        "# Evil Hermes — Full Documentation\n",
        (
            "This file is the entire Evil Hermes documentation concatenated for LLM "
        ...
        "Canonical site: https://evil-hermes.local/docs\n",
        "Short index: https://evil-hermes.local/docs/llms.txt\n",
        "\n---\n\n",
    ]
