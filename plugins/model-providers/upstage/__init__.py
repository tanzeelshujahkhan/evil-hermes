...
# When the user hasn't picked a reasoning effort, Evil Hermes passes
...
# ON at this effort — matching the "medium (default)" that Evil Hermes' /reasoning
...
class UpstageProfile(ProviderProfile):
    ...
    def build_api_kwargs_extras(
        ...
        # Map Evil Hermes' effort vocabulary onto Solar's accepted set. xhigh/max/
