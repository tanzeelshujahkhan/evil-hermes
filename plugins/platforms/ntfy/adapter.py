"""ntfy platform adapter (Evil Hermes plugin).
...
a Evil Hermes dependency.

This adapter ships as a Evil Hermes platform plugin under
``plugins/platforms/ntfy/``. The Evil Hermes plugin loader scans the
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        install_hint="pip install httpx   # already a Evil Hermes dependency",
