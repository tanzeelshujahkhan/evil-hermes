"""SimpleX Chat platform adapter (Evil Hermes plugin).
...
``plugins/platforms/simplex/``. The Evil Hermes plugin loader scans the
...
# Imported at module top because they're stdlib-only inside Evil Hermes — no
