(function () {
  ...
  async function buildShareImage(achievement) {
    ...
    ctx.fillText("HERMES AGENT  ·  evil-hermes.nousresearch.com", 70, H - 40);
  ...
  function ShareDialog({ achievement, onClose }) {
    ...
    function tweetText() {
      ...
      const tmpl = tx(t, "share.tweet_text", "Just unlocked {tier_part}\"{name}\" in Evil Hermes ☤", {
        tier_part: tierPart,
        name: achievement.name,
      });
      return tmpl + "\n\n@tanzeelshujahkhan · https://evil-hermes.nousresearch.com";
    }
