...
(function () {
  ...
  const DOCS_URL = "https://evil-hermes.local/docs/user-guide/features/kanban";
  const DOCS_TUTORIAL_URL = "https://evil-hermes.local/docs/user-guide/features/kanban-tutorial";
