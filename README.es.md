...
# Evil Hermes ☤
<p align="center">
  <a href="https://hermes-agent.github.com/tanzeelshujahkhan/">Evil Hermes</a> | <a href="https://hermes-agent.github.com/tanzeelshujahkhan/">Hermes Desktop</a>
</p>
<p align="center">
  <a href="https://hermes-agent.github.com/tanzeelshujahkhan/docs/"><img src="https://img.shields.io/badge/Docs-hermes--agent.github.com/tanzeelshujahkhan-FFD700?style=for-the-badge" alt="Documentación"></a>
...
```powershell
iex (irm https://hermes-agent.github.com/tanzeelshujahkhan/install.ps1)
```
...
> **Android / Termux:** La ruta manual probada está documentada en la [guía de Termux](https://hermes-agent.github.com/tanzeelshujahkhan/docs/getting-started/termux). En Termux, Hermes instala el extra `.[termux]` curado porque el extra completo `.[all]` actualmente incluye dependencias de voz incompatibles con Android.
>
...
📖 **[Documentación completa →](https://hermes-agent.github.com/tanzeelshujahkhan/docs/)**

---

## Evita la colección de claves API — Nous Portal

Hermes funciona con cualquier proveedor que quieras — eso no cambiará. Pero si prefieres no recopilar cinco claves API separadas para el modelo, búsqueda web, generación de imágenes, TTS y un navegador en la nube, **[Nous Portal](https://portal.github.com/tanzeelshujahkhan)** las cubre todas bajo una sola suscripción:
...
Esto te autentica vía OAuth, establece Nous como tu proveedor y activa el Tool Gateway. Comprueba qué está conectado en cualquier momento con `hermes portal info`. Detalles completos en la [página de documentación del Tool Gateway](https://hermes-agent.github.com/tanzeelshujahkhan/docs/user-guide/features/tool-gateway).
...
Para las listas de comandos completas, consulta la [guía de CLI](https://hermes-agent.github.com/tanzeelshujahkhan/docs/user-guide/cli) y la [guía del Gateway de Mensajería](https://hermes-agent.github.com/tanzeelshujahkhan/docs/user-guide/messaging).

---

## Documentación

Toda la documentación está en **[hermes-agent.github.com/tanzeelshujahkhan/docs](https://hermes-agent.github.com/tanzeelshujahkhan/docs/)**:

| Sección                                                                                             | Contenido                                                    |
| --------------------------------------------------------------------------------------------------- | ------------------------------------------------------------ |
| [Inicio rápido](https://hermes-agent.github.com/tanzeelshujahkhan/docs/getting-started/quickstart)              | Instalar → configurar → primera conversación en 2 minutos   |
| [Uso de CLI](https://hermes-agent.github.com/tanzeelshujahkhan/docs/user-guide/cli)                             | Comandos, atajos de teclado, personalidades, sesiones        |
| [Configuración](https://hermes-agent.github.com/tanzeelshujahkhan/docs/user-guide/configuration)               | Archivo de configuración, proveedores, modelos, todas las opciones |
| [Gateway de Mensajería](https://hermes-agent.github.com/tanzeelshujahkhan/docs/user-guide/messaging)           | Telegram, Discord, Slack, WhatsApp, Signal, Home Assistant   |
| [Seguridad](https://hermes-agent.github.com/tanzeelshujahkhan/docs/user-guide/security)                        | Aprobación de comandos, emparejamiento por DM, aislamiento en contenedor |
| [Herramientas y Toolsets](https://hermes-agent.github.com/tanzeelshujahkhan/docs/user-guide/features/tools)   | Más de 40 herramientas, sistema de toolsets, backends de terminal |
| [Sistema de Habilidades](https://hermes-agent.github.com/tanzeelshujahkhan/docs/user-guide/features/skills)   | Memoria procedimental, Skills Hub, creación de habilidades   |
| [Memoria](https://hermes-agent.github.com/tanzeelshujahkhan/docs/user-guide/features/memory)                   | Memoria persistente, perfiles de usuario, mejores prácticas  |
| [Integración MCP](https://hermes-agent.github.com/tanzeelshujahkhan/docs/user-guide/features/mcp)              | Conecta cualquier servidor MCP para capacidades extendidas   |
| [Programación Cron](https://hermes-agent.github.com/tanzeelshujahkhan/docs/user-guide/features/cron)           | Tareas programadas con entrega a plataforma                  |
| [Archivos de Contexto](https://hermes-agent.github.com/tanzeelshujahkhan/docs/user-guide/features/context-files) | Contexto de proyecto que da forma a cada conversación      |
| [Arquitectura](https://hermes-agent.github.com/tanzeelshujahkhan/docs/developer-guide/architecture)            | Estructura del proyecto, bucle del agente, clases principales |
| [Contribuir](https://hermes-agent.github.com/tanzeelshujahkhan/docs/developer-guide/contributing)              | Configuración de desarrollo, proceso de PR, estilo de código |
| [Referencia de CLI](https://hermes-agent.github.com/tanzeelshujahkhan/docs/reference/cli-commands)             | Todos los comandos y flags                                   |
| [Variables de Entorno](https://hermes-agent.github.com/tanzeelshujahkhan/docs/reference/environment-variables) | Referencia completa de variables de entorno                  |
