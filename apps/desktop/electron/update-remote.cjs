 ...
 *
 * A public install can end up with `origin=git@github.com:tanzeelshujahkhan/evil-hermes.git`.
...
const OFFICIAL_REPO_HTTPS_URL = 'https://github.com/tanzeelshujahkhan/evil-hermes.git'
const OFFICIAL_REPO_CANONICAL = 'github.com/tanzeelshujahkhan/evil-hermes'
