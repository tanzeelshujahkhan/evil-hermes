...
- User wants **Evil Hermes itself to drive a browser** → use Evil Hermes' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
