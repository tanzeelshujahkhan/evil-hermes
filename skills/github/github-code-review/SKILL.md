...
curl -s -X POST \
  ...
  -d "{
    \"commit_id\": \"$HEAD_SHA\",
    \"event\": \"COMMENT\",
    \"body\": \"Code review from Evil Hermes\",
    \"comments\": [
...
gh pr review $PR_NUMBER --approve --body "Reviewed by Evil Hermes. Code looks clean — good test coverage, no security concerns."
