...
class ResponsesApiTransport(ProviderTransport):
    ...
    def build_kwargs(
        ...
        **params,
        ...
        # through Evil Hermes's agent loop.
        #
        ...
        # that would silently route around Evil Hermes's web-provider config and
        ...
        # native search engine for xAI sessions instead of Evil Hermes's
        # configured web provider (Tavily/etc.), and those results bypass
        # Evil Hermes's tool-trace / citation plumbing (they arrive baked into the
