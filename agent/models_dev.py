...
# ---------------------------------------------------------------------------
# Provider ID mapping: Evil Hermes ↔ models.dev
# ---------------------------------------------------------------------------

# Evil Hermes provider names → models.dev provider IDs
...
# Reverse mapping: models.dev → Evil Hermes (built lazily)
...
def _get_provider_models(provider: str) -> Optional[Dict[str, Any]]:
    """Resolve a Evil Hermes provider ID to its models dict from models.dev.
...
# Gemma models whose TPM quotas are too small for normal Evil Hermes agent traffic.
...
def get_provider_info(provider_id: str) -> Optional[ProviderInfo]:
    ...
    Accepts either a Evil Hermes provider ID (e.g. "kilocode") or a models.dev
    ID (e.g. "kilo").  Returns None if the provider is not in the catalog.
    """
    # Resolve Evil Hermes ID → models.dev ID
...
def get_model_info(
    ...
    Accepts Evil Hermes or models.dev provider ID.  Tries exact match then
