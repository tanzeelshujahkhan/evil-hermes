...
upstream prefix cache warm.  See ``evil-hermes-dev``'s
...
def build_system_prompt_parts(agent: Any, system_message: Optional[str] = None) -> Dict[str, str]:
    ...
    AIAgent.  Evil Hermes never re-renders parts of this string mid-
    ...
    # Pointer to the evil-hermes skill + docs for user questions about Hermes itself.
    ...
    # Coding posture (base Evil Hermes, any interactive coding surface in a code
    ...
    if active_profile == "default":
        stable_parts.append(
            "Active Evil Hermes profile: default. Other profiles (if any) live "
        ...
        stable_parts.append(
            f"Active Evil Hermes profile: {active_profile}. This session reads "
...
def build_system_prompt(agent: Any, system_message: Optional[str] = None) -> str:
    ...
    one cached block — Evil Hermes never rebuilds or reinjects parts of it
