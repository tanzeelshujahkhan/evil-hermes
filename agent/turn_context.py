...
def build_turn_context(
    ...
    *,
    ...
    if agent.compression_enabled and _should_run_preflight_estimate(
        ...
        # Evil Hermes only initiates compaction in "hermes" mode (#36801).
        _codex_native_auto = (
        ...
        if _preflight_deferred:
            ...
            logger.info(
                "Skipping Evil Hermes preflight compression for codex app-server "
                "(mode=%s); Evil Hermes will not start thread compaction here.",
