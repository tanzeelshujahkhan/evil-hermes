"""Coding-context awareness — base Evil Hermes, every interactive surface.

When the user runs Evil Hermes inside a code workspace (CLI, TUI, desktop app, or an
editor over ACP), Evil Hermes shifts into a **coding posture**. This module is the
...
def is_coding_context(
    *,
    ...
    """Whether Evil Hermes should operate in its coding posture right now."""
