...
When a provider returns a non-OK status on a *streaming* request, Evil Hermes reads
...
streams"), generalized to cover Evil Hermes's three streaming error-body sites
