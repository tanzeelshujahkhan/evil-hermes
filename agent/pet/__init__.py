...
an 8-column × 9-row atlas; older Evil Hermes/petdex sheets used an 8-row atlas.
Evil Hermes infers the row taxonomy from the sheet and maps agent activity onto
