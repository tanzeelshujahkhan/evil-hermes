"""Lightweight internationalization (i18n) for Evil Hermes static user-facing messages.

Scope (thin slice, by design): only the highest-impact static strings shown
to the user by Evil Hermes itself -- approval prompts, a handful of gateway slash
