...
class GatewaySlashCommandsMixin:
    ...
    async def _handle_version_command(self, event: MessageEvent) -> str:
        """Handle /version — show the running Evil Evil Hermes version."""
    ...
    async def _handle_update_command(self, event: MessageEvent) -> str:
        """Handle /update command — update Evil Evil Hermes to the latest version.
        ...
        if is_managed():
            return f"✗ {format_managed_message('update Evil Evil Hermes')}"
