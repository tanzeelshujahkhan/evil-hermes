...
# Bootstrap Open WebUI against Evil Hermes' OpenAI-compatible API server.
#
...
#   HERMES_API_MODEL_NAME='Evil Hermes'

OPEN_WEBUI_PORT="${OPEN_WEBUI_PORT:-8080}"
OPEN_WEBUI_HOST="${OPEN_WEBUI_HOST:-127.0.0.1}"
OPEN_WEBUI_NAME="${OPEN_WEBUI_NAME:-Evil Hermes WebUI}"
...
HERMES_API_MODEL_NAME="${HERMES_API_MODEL_NAME:-Evil Hermes}"
...
install_systemd_user_service() {
  ...
  cat > "$unit" <<EOF
[Unit]
Description=Open WebUI connected to Evil Hermes
