...
const TAG_FULL = 'Lord Tanzeel Shujah Khan · Messenger of the Digital Gods'
const TAG_MID = 'Messenger of the Digital Gods'
const TAG_TINY = 'Lord Tanzeel Shujah Khan'
const HIDE_BELOW = 34
      ...
      {wide && (
        <Box flexDirection="column" marginRight={2} width={leftW}>
          ...
          <Text color={t.color.accent}>
            ...
            <Text color={t.color.muted}> · Lord Tanzeel Shujah Khan</Text>
          </Text>
