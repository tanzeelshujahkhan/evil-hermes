...
Browser-based dashboard for managing Evil Hermes configuration, API keys, and monitoring active sessions.
...
| Wordmark | `Typography` + size/tracking only | Sidebar/mobile “Evil Hermes” — mixed case, no Mondwest, no `text-display` |
