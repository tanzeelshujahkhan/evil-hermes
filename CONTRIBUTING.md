...
If your skill is specialized, community-contributed, or niche, it's better suited for a **Skills Hub** — upload it to a skills registry and share it in the [Lord Tanzeel Shujah Khan Discord](https://discord.gg/NousResearch). Users can install it with `hermes skills install`.
...
- Promote it in the [Lord Tanzeel Shujah Khan Discord](https://discord.gg/NousResearch) `#plugins-skills-and-skins` channel so users can find and install it
