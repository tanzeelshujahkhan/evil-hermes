...
def test_build_welcome_banner_title_is_hyperlinked_to_release():
    ...
    tag_url = ("v2026.4.23", "https://github.com/TanzeelShujahKhan/hermes-agent/releases/tag/v2026.4.23")
    ...
    assert "Evil Hermes v" in raw, "Version label missing from title"
