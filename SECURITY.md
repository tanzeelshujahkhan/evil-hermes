...
This document describes Evil Hermes's trust model, names the one
...
- **Stance.** An explicit statement in Evil Hermes's documentation
...
- **Evil Hermes's own Docker image and Compose setup.** Lighter-
...
Under a whole-process wrapper, Evil Hermes's in-process heuristics
...
itself. Bugs in Evil Hermes's plugin-install or plugin-discovery
...
- Trust-model documentation violations: code behaving contrary to
  what this policy, Evil Hermes's own documentation, or reasonable
...
- **Community-contributed skills and plugins.** Third-party skills
  ...
  plugins are in the operator's review surface, not Evil Hermes's
