    ...
    for config_path in configs:
        try:
            ...
            for line in content.split('\n'):
                # Skip the "# Evil Hermes" comment and following line
                if '# Evil Hermes' in line or '# hermes-agent' in line:
                    skip_next = True
                    continue
...
def run_uninstall(args):
    ...
    print()
    print(color("┌─────────────────────────────────────────────────────────┐", Colors.MAGENTA, Colors.BOLD))
    print(color("│            ⚕ Evil Evil Hermes Uninstaller                  │", Colors.MAGENTA, Colors.BOLD))
    print(color("└─────────────────────────────────────────────────────────┘", Colors.MAGENTA, Colors.BOLD))
    print()
...
def _print_uninstall_dry_run(*, project_root: Path, hermes_home: Path, full_uninstall: bool) -> None:
    ...
    print("  • Evil Hermes PATH entries from shell configs / Windows User PATH")
    print("  • Evil Hermes wrapper scripts and Evil Hermes-managed node/npm/npx symlinks")
    print("  • Desktop Chat GUI artifacts")
    print(f"  • Code checkout: {project_root}")
    if full_uninstall:
        print(f"  • Evil Hermes config/data: {hermes_home}")
        ...
        print(f"  • Keep Evil Hermes config/data: {hermes_home}")
    print()
...
def _perform_uninstall(
    *,
    ...
    print()
    print("Thank you for using Evil Evil Hermes! ⚕")
    print()
