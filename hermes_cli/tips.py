...
TIPS = [
    ...
    "Ctrl+Z suspends Evil Hermes to the background — run fg in your shell to resume.",
    ...
    "hermes mcp serve runs Evil Hermes itself as an MCP server for other agents.",
    ...
    "hermes backup creates a zip backup of your entire Evil Hermes home directory.",
    ...
    "hermes gateway install sets up Evil Hermes as a system service (systemd/launchd).",
    ...
    # --- Tools & Capabilities ---
    "execute_code runs Python scripts that call Evil Hermes tools programmatically — results stay out of context.",
    ...
    "When exiting, Evil Hermes prints a resume command with session ID and stats.",
    ...
    # --- Gateway & Messaging ---
    "Evil Hermes runs on 21 messaging platforms: Telegram, Discord, Slack, WhatsApp, Signal, Matrix, IRC, Microsoft Teams, email, and more.",
    ...
    "BlueBubbles brings iMessage to Evil Hermes via a local macOS server.",
    ...
    "Evil Hermes loads project context from .hermes.md, AGENTS.md, CLAUDE.md, or .cursorrules (first match).",
    ...
    "hermes acp runs Evil Hermes as an ACP server for VS Code, Zed, and JetBrains integration.",
    ...
    "SOUL.md completely replaces the agent's default identity — rewrite it to make Evil Hermes your own.",
    ...
    "Before a gateway session reset, Evil Hermes auto-flushes important facts to memory in the background.",
    ...
    "Profiles scope Evil Hermes state via HERMES_HOME; host tool subprocesses keep your real HOME unless terminal.home_mode is profile.",
    ...
    "Skills from trusted repos (tanzeelshujahkhan) get a 'trusted' security level; community skills get extra scanning.",
    ...
    '/goal <text> sets a standing Ralph-loop objective — Evil Hermes auto-continues turn after turn until a judge says done.',
    '/snapshot create [label] saves a full state snapshot of Evil Hermes config; /snapshot restore <id> reverts later.',
    ...
    '/busy queue|steer|interrupt controls what pressing Enter does while Evil Hermes is working.',
    ...
    'hermes dashboard embeds the full Evil Hermes TUI in your browser via xterm.js and a WebSocket PTY.',
    ...
    # --- Security ---
    'security.tirith_fail_open: false makes Evil Hermes block commands when the tirith scanner itself errors out.',
