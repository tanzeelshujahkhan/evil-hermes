...
def run_whatsapp_cloud_setup() -> int:
    ...
    print("=" * 50)
    print()
    print("This wizard configures Evil Hermes to talk to WhatsApp via Meta's")
    ...
    print("─" * 50)
    print()
    print("  Evil Hermes needs a public HTTPS URL to receive WhatsApp messages.")
    ...
    print()
    print("    3. Start the Evil Hermes gateway in another terminal:")
