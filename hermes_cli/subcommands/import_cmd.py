...
def build_import_cmd_parser(subparsers, *, cmd_import: Callable) -> None:
    ...
    import_parser = subparsers.add_parser(
        "import",
        help="Restore an Evil Hermes backup from a zip file",
        description="Extract a previously created Evil Hermes backup into your "
        "Evil Hermes home directory, restoring configuration, skills, "
        "sessions, and data",
    )
