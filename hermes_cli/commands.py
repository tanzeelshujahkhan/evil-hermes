...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("rollback", "List or restore filesystem checkpoints", "Session",
               args_hint="[number]"),
    CommandDef("snapshot", "Create or restore state snapshots of Evil Hermes config/state", "Session",
    ...
    CommandDef("steer", "Inject a message after the next tool call without interrupting", "Session",
               args_hint="<prompt>"),
    CommandDef("goal", "Set a standing goal Evil Hermes works on across turns until achieved", "Session",
    ...
    CommandDef("busy", "Control what Enter does while Evil Hermes is working", "Configuration",
    ...
    CommandDef("update", "Update Evil Hermes Agent to the latest version", "Info"),
    CommandDef("version", "Show Evil Hermes Agent version", "Info", aliases=("v",)),
...
Telegram only displays a small BotCommand menu in practice.  The full Evil Hermes
...
def slack_native_slashes() -> list[tuple[str, str, str]]:
    ...
    entries.append(("hermes", "Talk to Evil Hermes or run a subcommand", "[subcommand] [args]"))
    seen.add("hermes")
