...
_DOCS_BASE = "https://evil-hermes.local/docs"
...
def _setup_webhooks():
    ...
    print()
    print_info("   Full guide: https://evil-hermes.local/docs/user-guide/messaging/webhooks/")
    print()
    ...
    print_info("   https://evil-hermes.local/docs/user-guide/messaging/webhooks/#configuring-routes")
    print()
