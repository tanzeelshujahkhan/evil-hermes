...
_DOCS_BASE = "https://evil-hermes.nousresearch.com/docs"
...
def _setup_webhooks():
    ...
    print()
    print_info("   Full guide: https://evil-hermes.nousresearch.com/docs/user-guide/messaging/webhooks/")
    print()
    ...
    print_info("   https://evil-hermes.nousresearch.com/docs/user-guide/messaging/webhooks/#configuring-routes")
    print()
